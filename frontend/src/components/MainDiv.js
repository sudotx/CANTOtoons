  ...
  const fetchMints = async () => {
    ...
    try {
      ...
      if (ethereum) {
        ...
        let allTokenIdsOfAdrress = await contract.walletOfOwner(
          userData.userAddress
        );
    ...
    <div className="mainDiv" id="mint">
      <div className="left">
        ...
        <div className="number">
          <div className="minus pumi" onClick={handleMinus}>
            -
          </div>
          <input
            type="number"
          ...
          />
          <div className="plus pumi" onClick={handlePlus}>
            +
          </div>
        </div>
        {inputValue > 0 && inputValue < 3 ? (
          <div className="sub_title u-mt-10">
            Price : {inputValue} X {cost} = {inputValue * cost} $SHM
          </div>
        ) : (
          <div className="sub_title u-mt-10">
            Each address can only mint 2 NFTs
          </div>
        )}
        <button
          disabled={
