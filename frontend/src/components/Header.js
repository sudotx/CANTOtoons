...
export default function Header({ noLinks }) {
  ...
  return (
    <div className="hearer_nav">
      <div>
        <Link to="/">
          <div className="title title_link">canto toons NFT</div>
        </Link>
      </div>
      {noLinks !== undefined ? (
        <div></div>
      ...
      <div className="header_connect">
          ...
          {currentAccount ? (
            isShardeum ? (
              <a
                ...
                target="_blank"
                href={
                  `https://explorer.liberty10.shardeum.org/account/` +
                  currentAccount
                }
              >
                {" "}
        ...
        {!isShardeum && (
          <button
            className="connect_button connect_button2"
            onClick={switchNetwork}
          >
            <img alt="Network logo" className="logo" src={metaMaskLogo} />
          </button>
        )}
      </div>
    </div>
